    ...
    75740: function (e, t, s) {
            ...
            let l = p[0],
              ...
              W = {
                ...
                set(t, r, n, o) {
                  ...
                  return Reflect.set(t, r, h, o), g(["set", [r], n, p]), !0;
                },
              },
              E = t(O, W);
            i.set(r, E);
        ...
        y = {
          ...
          formatUniversalUrl(e, t, s) {
            ...
            if (r.startsWith("https://t.me")) {
              let e = g.from(t).toString("base64").replace(/[=]/g, "");
              r.endsWith("/") && (r = r.slice(0, -1)),
                this.setWalletConnectDeepLink(r, s);
              let n = new URL(r);
              return n.searchParams.set("startapp", e), n.toString();
            }
            r.endsWith("/") || (r = `${r}/`),
              this.setWalletConnectDeepLink(r, s);
            let n = encodeURIComponent(t);
          ...
          setModalVersionInStorage() {
            try {
              "undefined" != typeof localStorage &&
                localStorage.setItem(y.WCM_VERSION, "2.7.0");
            } catch (e) {
      ...
      var E = Object.defineProperty,
        ...
        M = (e, t) => {
          ...
          if (j) for (var s of j(t)) A.call(t, s) && k(e, s, t[s]);
          return e;
        };
      let U = "https://explorer-api.walletconnect.com",
        P = "js-2.7.0";
      async function D(e, t) {
        let s = M({ sdkType: "wcm", sdkVersion: P }, t),
          r = new URL(e, U);
        return (
      ...
      let S = {
        ...
        getWalletImageUrl: (e) =>
          `${U}/w3m/v1/getWalletImage/${e}?projectId=${W.state.projectId}&sdkType=wcm&sdkVersion=${P}`,
        getAssetImageUrl: (e) =>
          `${U}/w3m/v1/getAssetImage/${e}?projectId=${W.state.projectId}&sdkType=wcm&sdkVersion=${P}`,
      };
      var T = Object.defineProperty,
        ...
        R = (e, t, s) =>
          t in e
            ...
            : (e[t] = s),
        $ = (e, t) => {
          for (var s in t || (t = {})) _.call(t, s) && R(e, s, t[s]);
      ...
      let V = y.isMobile(),
        ...
        K = {
          ...
          async getRecomendedWallets() {
            ...
            if (y.isArray(e)) {
              let t = e.join(","),
                { listings: s } = await S.getAllListings({ recommendedIds: t }),
                r = Object.values(s);
              r.sort((t, s) => e.indexOf(t.id) - e.indexOf(s.id)),
                (H.recomendedWallets = r);
            } else {
              let { chains: e, isAuth: s } = I.state,
                ...
                { listings: i } = V
                  ? await S.getMobileListings(o)
                  : await S.getDesktopListings(o);
              H.recomendedWallets = Object.values(i);
            }
          ...
          async getWallets(e) {
            let t = $({}, e),
              ...
              { recomendedWallets: n } = H;
            if ("ALL" === r) return H.wallets;
            n.length
          ...
          open: async (e) =>
            new Promise((t) => {
              ...
              if (
                ...
                I.setWalletConnectUri(null == e ? void 0 : e.uri),
                I.setChains(null == e ? void 0 : e.chains),
      ...
      var J = Object.defineProperty,
        ...
        X = (e, t) => {
          ...
          if (q) for (var s of q(t)) G.call(t, s) && Q(e, s, t[s]);
          return e;
        };
      let Y = f({
          themeMode:
        ...
        ee = f({ open: !1, message: "", variant: "success" }),
        et = {
          state: ee,
      ...
      class n {
        ...
        async initUi() {
          if ("undefined" != typeof window) {
            await s.e(6909).then(s.bind(s, 56909));
